          ...
          <div className="grid md:grid-cols-3 gap-8 items-start">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-gray-400 mb-2">
                ...
                <a href="tel:+905413812114" className="hover:text-rose-600 transition-colors">+90 541 381 2114</a>
              </div>
              <div className="flex items-center gap-2 text-sm text-gray-400">
                <Zap className="w-4 h-4 text-emerald-500" />
                <a href="https://wa.me/905413812114" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-500 transition-colors">WhatsApp Destek</a>
              </div>
            </div>
